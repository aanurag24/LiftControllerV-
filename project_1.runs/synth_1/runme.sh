...
HD_PWD='E:/Vlsi-pro/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LiftC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LiftC.tcl
