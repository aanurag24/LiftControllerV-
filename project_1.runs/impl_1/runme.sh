...
HD_PWD='E:/Vlsi-pro/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LiftC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LiftC.tcl -notrace
